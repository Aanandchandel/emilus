...
import { toggleSidebar } from "../../redux/slices/render/render";
import logo from "./static/logo.png"
import logo_sm from "./static/logo-sm.png"
const Header=()=>{
    const showSidebarr=useSelector((state)=>{ return state.renderslice.sidebar})
    ...
    <div className="userInfodiv" >
        ...
        <div className='userprofilebox headeliments'>
            <img src='https://emilus.themenate.net/img/avatars/thumb-1.jpg' alt='profile' />
            <div className="userInfoDiv">
            <div id="username" >Charlie Howard</div>
            <span id="userstatus" > Frontend Developer </span>
            </div>
        </div>
        </div>
...
return <div className={show?" searchbarr1":""} > <div className={show?"searchbarr searchbarr2":"searchbarr"}>
            <svg  onClick={()=>{ setShow(true)}}  className="headeliments headersvgs searchbarricon" viewBox="64 64 896 896" focusable="false" data-icon="search" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M909.6 854.5L649.9 594.8C690.2 542.7 712 479 712 412c0-80.2-31.3-155.4-87.9-212.1-56.6-56.7-132-87.9-212.1-87.9s-155.5 31.3-212.1 87.9C143.2 256.5 112 331.8 112 412c0 80.1 31.3 155.5 87.9 212.1C256.5 680.8 331.8 712 412 712c67 0 130.6-21.8 182.7-62l259.7 259.6a8.2 8.2 0 0011.6 0l43.6-43.5a8.2 8.2 0 000-11.6zM570.4 570.4C528 612.7 471.8 636 412 636s-116-23.3-158.4-65.6C211.3 528 188 471.8 188 412s23.3-116.1 65.6-158.4C296 211.3 352.2 188 412 188s116.1 23.2 158.4 65.6S636 352.2 636 412s-23.3 116.1-65.6 158.4z"></path></svg>
            { <input placeholder="Search" className= {show?"searchinput searchinput1":"searchinput hide"} type="text" />}
            
        </div> 
        {<div>{ <svg onClick={()=>{ setShow(false)}} className={show?"headeliments headersvgs searchbarrcross":"headeliments headersvgs searchbarrcross hide"} viewBox="64 64 896 896" focusable="false" data-icon="close" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M563.8 512l262.5-312.9c4.4-5.2.7-13.1-6.1-13.1h-79.8c-4.7 0-9.2 2.1-12.3 5.7L511.6 449.8 295.1 191.7c-3-3.6-7.5-5.7-12.3-5.7H203c-6.8 0-10.5 7.9-6.1 13.1L459.4 512 196.9 824.9A7.95 7.95 0 00203 838h79.8c4.7 0 9.2-2.1 12.3-5.7l216.5-258.1 216.5 258.1c3 3.6 7.5 5.7 12.3 5.7h79.8c6.8 0 10.5-7.9 6.1-13.1L563.8 512z"></path></svg>
             }</div>}</div>
}
